                        ...
                        >
                            <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                                    ...
                                    <div className="sm:flex sm:flex-col sm:justify-center sm:items-center">
                                        ...
                                        <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                            <Dialog.Title as="h3" className="text-base font-normal leading-6 text-gray-900">
                                                Tem certeza que quer remover <a className="text-base font-bold leading-6 text-gray-900">{nome}</a>?
                                            </Dialog.Title>
                                            <div className="mt-2">
                                ...
                                <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                                    ...
                                    <button
                                        type="button"
                                        className="inline-flex w-full justify-center rounded-md bg-red-600 px-3 py-2 mr-3 text-sm font-semibold text-white shadow-sm hover:bg-red-500 sm:ml-3 sm:w-auto"
                                    >
                                        Remove
                                    </button>
